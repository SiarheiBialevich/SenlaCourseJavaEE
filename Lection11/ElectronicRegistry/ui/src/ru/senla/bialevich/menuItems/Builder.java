...
import ru.senla.bialevich.menuAction.orderAction.AddRegistration;
import ru.senla.bialevich.menuAction.orderAction.GetRegistrationList;
...
public class Builder {
    ...
    public Menu buildMenu() {
        ...
        orderMenu.addMenuItem(new MenuItem("Add order", new AddRegistration(), orderMenu));
        orderMenu.addMenuItem(new MenuItem("Get order list", new GetRegistrationList(), orderMenu));
