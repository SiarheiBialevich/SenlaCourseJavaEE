...
public class Guest extends BaseEntity implements Serializable {
    ...
    @ConfigProperty(configName = "annotation.properties", propertyName = "Guest.id", type = Integer.class)
    private Integer id = 1;

    @ConfigProperty(configName = "annotation.properties", propertyName = "Guest.name", type = String.class)
    private String name;

    @ConfigProperty(configName = "annotation.properties", propertyName = "Guest.surname", type = String.class)
